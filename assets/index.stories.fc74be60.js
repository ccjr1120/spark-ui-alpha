import{r,a as i,j as e}from"./jsx-runtime.4144e1e4.js";import{u as d,a as m}from"./index.e1313646.js";import"./iframe.52a076aa.js";const h=r.exports.createContext(null);function g(){return r.exports.useContext(h)}function l(c){const{name:n}=c,t=g();if(t==null)throw new Error("no CollapseContext provied");const{value:a,onChange:o}=t,s=m("collapse-panel"),u=d([s.b()]),x=d([s.e("header"),s.useIs("active",n===a)]),f=d([s.e("content"),s.useIs("active",n===a)]),C=r.exports.useCallback(()=>{o(n)},[n,o]);return i("div",{className:u,children:[i("div",{className:x,onClick:C,children:[e("span",{children:">"}),"header"]}),i("main",{className:f,children:[e("div",{children:"Consistent with real life: in line with the process and logic of real life, and comply with languages and habits that the users are used to;"}),e("div",{children:"Consistent within interface: all elements should be consistent, such as: design style, icons and texts, position of elements, etc."})]})]})}function p(c){const{children:n,value:t,onChange:a}=c,o=m("collapse"),s=d([o.b()]),u=r.exports.useMemo(()=>({value:t,onChange:a}),[t,a]);return e(h.Provider,{value:u,children:e("div",{className:s,children:e("div",{className:o.m("content"),children:n})})})}p.Panel=l;const w={parameters:{storySource:{source:`import { useState } from 'react';
...
//# sourceMappingURL=index.stories.fc74be60.js.map
