...
const DateRangePickerArrowSwitcher = ({ ...others }) => (
              ...
              {view === 'day' && (
                <DayPicker
                  ...
                  renderDay={(day) => {
                    ...
                    const isInRange = selectStartDate
                      && dayDate.isBetween(
                        selectStartDate,
                        selectEndDate
              ...
              {view === 'month' && (
                <MonthPicker
                  ...
                  renderMonth={(month) => {
                    ...
                    const isStartDate = monthDate.isSame(selectStartDate, 'month');
              ...
              {view === 'quarter' && (
                <QuarterPicker
                  ...
                  renderQuarter={(quarter) => {
                    ...
                    const isStartDate = quarterDate.isSame(selectStartDate, 'quarter');
                    const isEndDate = quarterDate.isSame(selectEndDate, 'quarter');
                    const hasEndDate = !!selectEndDate;
                    const isHoverDate = quarterDate.isSame(hoverDate, 'quarter');
                    const defaultBorderRadiusStyle = getBorderRadiusStyle({
                      dateType: 'quarter',
                      date: quarterDate,
                      isStartDate,
              ...
              {view === 'year' && (
                <YearPicker
                  ...
                  renderYear={(year) => {
                    ...
                    const isStartDate = yearDate.isSame(selectStartDate, 'year');
